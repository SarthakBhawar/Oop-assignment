/*Define a class to represent a bank aacount which include the following member such as name of depositior , accout no, withdrawl amount, balance amount .
also include memeber function to assign initial value to deposit an amount , to withdraw an amount after checking current balance , to display name and balance*/.  
